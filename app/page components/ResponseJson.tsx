  ...
  return (
    <div className="mb-6">
      <div className="flex items-start gap-3 mb-4">
        <div className="w-10 h-10 rounded-full bg-leafy-green flex items-center justify-center text-white font-bold">AI</div>
        <div className="bg-white p-4 rounded-lg shadow-sm border border-gray-200 w-full">
          <h3 className="text-lg font-semibold text-gray-900 mb-2">{data.recipeName}</h3>
          ...
          <div className="mb-3">
            ...
            <ul className="list-disc pl-5 text-gray-700">
              {Array.isArray(data.ingredients) && data.ingredients.map((ing: string, i: number) => (
                <li key={i}>{ing}</li>
              ))}
            </ul>
          </div>
          ...
          <div className="mb-3">
            <h4 className="text-sm font-semibold text-gray-800 mb-1">Instructions</h4>
